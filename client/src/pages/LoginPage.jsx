...
export default function LoginPage() {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden">
      ...
      {/* Login Content */}
      <div className="relative z-10 flex w-full h-full px-10 py-10 justify-between items-center">
        <div className="bg-white bg-opacity-90 w-full sm:w-full md:w-1/2 lg:w-1/3 px-7 py-7 rounded-xl justify-center align-middle">
                ...
                <div type='button' className="" onClick={() => setShowPassword((prev) => !prev)}>
                  {showPassword ? (
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                      ...
                      <path d="M15.75 12c0 .18-.013.357-.037.53l-4.244-4.243A3.75 3.75 0 0115.75 12z" />
                      <path d="M12.53 15.713l-4.243-4.244a3.75 3.75 0 004.243 4.243z" />
        ...
        <div className= "hidden lg:flex flex-col right-box">
          <div className='flex flex-col -ml-96 gap-3'>
            <div className='text-3xl font-black text-white'>Welcome to</div>
            <div>
